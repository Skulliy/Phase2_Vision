...
def decision_step(Rover):
    ...
    #are we in the middle of a circle condition and trying to break out of it?
    ...
    #detect if our vehicles is doing circles
    if Rover.steer==15 or Rover.steer==-15:
        #how long have we been doing circles?
        if time.time() - circle_start_time > 10:  #more than 10 seconds?...try to break out
            Rover.mode = "stuckCircle"
            return Rover
    else:
        circle_start_time=time.time()
